...
namespace Lab8Task2
{
	class MainClass
	{
		...
		public static double Norm(double[] a, double[] b) /*checked*/
		{
			double sum = 0;
			for (int i = 0; i < a.Length; i++)
			{
		...
		{
			double[] c = new double[b.Length];
			for (int i = 0; i < b.Length; i++) /*Заменить на a.Length? Думаю, что не стоит. UPD:не стоит, всё верно, в Java a.Length == размеру строки м-цы*/
			{
